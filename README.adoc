...
The script turns the data in the Central-Products-Lis.csv file into a hash. To use the script run the command followed by the desired path/source file, and then followed by the destination file (i.e source.rb).
...
- Run the script by typing in the csv file and path as first argument, and the destination path as second argument:
